...
## Unreleased (the wheel over the strips)
...
## Unreleased (one collapse button instead of two)
...
## Unreleased (the chrome scrim survives a fresh load)
...
## Unreleased (the conversation page can be a solid page)
...
## Unreleased (the skin can reach the conversation page)
...
## Unreleased (glass reaches three more surfaces)
...
## Unreleased (settings apply app-wide)
...
## Unreleased (settings survive a restart)
...
## Unreleased (wallpaper, whole window)
